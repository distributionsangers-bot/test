...
export async function openEventModal(eventToEdit = null) {
    ...
    modal.id = modalId;
    modal.className = 'fixed inset-0 z-[60] flex items-center justify-center p-2 sm:p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in';
...
function renderModalStructure() {
    return `
        <div class="bg-white rounded-2xl sm:rounded-[2rem] shadow-2xl w-full max-w-4xl max-h-[85vh] sm:max-h-[90vh] flex flex-col overflow-hidden animate-scale-in">
            <!-- Header -->
