-- Drop ALL potential ambiguous versions of the function
...
BEGIN
    ...
    WHERE r.user_id = v_user_id
        ...
        AND r.shift_id != p_shift_id -- Exclude current registration if any (though logic blocks double reg anyway)
        AND (
